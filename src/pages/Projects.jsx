...
const Projects = () => {
  ...
  const allImages = [
    ...
    },
    {
      ...
      image2: "https://images.unsplash.com/photo-1613575569208-b769cfe6f67a?q=80&w=1170&auto=format&fit=crop&ixlib=rb-4.1.0&ixid=M3wxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8fA%3D%3D",
    },
    {
      ...
      <main className='main'>
        ...
        <div className="all-images-div min-h-screen">
          {allImages.map((elem, idx) => {
            return <div key={idx} className="images-div lg:w-full lg:h-[600px] lg:flex lg:gap-4 lg:mb-4 lg:p-5">
